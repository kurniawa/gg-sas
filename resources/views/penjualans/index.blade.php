...
<div class="flex items-center justify-between mt-2 px-2">
    <div class="bg-white rounded p-1 shadow drop-shadow flex items-center">
        <div>
        ...
        <h3 class="font-semibold text-lg ml-2">Daftar Penjualan</h3>
    </div>
    <div>
        <a href="{{ route('penjualans.pilih_tipe_surat') }}" class="bg-pink-500 text-white p-1 rounded font-semibold">+Penjualan</a>
    </div>
</div>
{{-- <feedback></feedback> --}}
<div class="m-2">
        ...
        <tr>
            ...
            <td>
                ...
                <div class="flex items-center">
                    <a href="{{ route('items.show', $penjualan->id) }}" class="bg-yellow-500 rounded p-1 text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M11.25 4.5l7.5 7.5-7.5 7.5m-6-15l7.5 7.5-7.5 7.5" />
                        </svg>
                    </a>
                    <form method="POST" action="{{ route('items.destroy', $penjualan->id) }}" class="ml-1 flex items-center" onsubmit="return confirm('Anda yakin ingin menghapus item ini?')">
                        @csrf
                        @method('DELETE')
